...
async def create_upload_files(files: List[UploadFile] = File(...)):
    ...
    content = head_html +  """
    <marquee width = "525" behavior = "alternate"><h1 style = "color:red;font-faily:Aria"> Here's Our Predictions </h1></marquee><br>
    """ + str(table_html) + """
...
async def main():
    content = head_html+"""
    <marquee width = "525" behavior = "alternate"><h1 style = "color:red;font-faily:Aria"> Please Upload Your Scenes</h1></marquee><br>
    <h3 style ="font-family:Arial"> We'll Try to Predict Which of These Categories They Are: </h3><br> 
    """

    original_paths = ['building.jpg', 'forest.jpg', 'glacier.jpg', 'mountain.jpg', 'sea.jpg', 'street.jpg']
...
def get_html_table(image_paths, names, column_labels):
    ...
    for name, image_path in zip(names, image_paths):
        ...
        s += '<td style="text-allign:center">' + name + '</td></tr>'
    s+='</table>'
